...
def main():
    ...
    with Progress(
        ...
        TextColumn("[bold gold1]VÉRIFICATION DE LA LICENCE VOID..."),
    ...
    pnl = Panel(
        ...
        border_style="#FFD700", box=box.DOUBLE_EDGE, padding=(1, 5), title="[bold #FFD700]VOID_LICENSE_ERROR"
    )
    console.print(Align.center(pnl))
    open_premium_links()
    console.print("\n")
    console.input(Align.center(" [dim]Appuyez sur [bold gold1]ENTRÉE[/] pour revenir au menu...[/]"))
