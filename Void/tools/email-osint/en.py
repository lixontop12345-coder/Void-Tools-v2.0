...
def main():
    ...
    with Live(layout, refresh_per_second=10, screen=True) as live:
        while loop_thread.is_alive():
            layout["header"].update(Panel(Align.center(Text.from_markup(f"[bold red]VOID-EMAIL ENGINE[/] [dim]||[/] [white]SCANNING...[/]")), border_style="red"))
            ...
            layout["footer"].update(Panel(Align.center(Text.from_markup(f"[dim]VOID ELITE OSINT SYSTEM - SCANNING PROTECTED[/]")), border_style="red"))
            time.sleep(0.1)
