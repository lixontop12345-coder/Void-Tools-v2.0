...
def boot():
    if sys.platform.startswith("win"): os.system("title VOID WEB // DIR BUSTER")
...
if __name__ == "__main__":
    try:
        ...
        console.print(Align.center(Panel(
            Text.from_markup("[bold red]VOID-TOOLS[/]  [dim]//[/]  [white]VOID WEB[/]  [dim]//[/]  [red]DIR BUSTER[/]"),
        ...
        with Progress(SpinnerColumn(spinner_name="point", style="red"), TextColumn("[dim white]{task.description}"), console=console, transient=True) as p:
            p.add_task(f"Fuzzing de {target}...", total=None)
        ...
        console.print()
        console.print(f" [bold green][✓] Terminé. {len(found)} chemins trouvés.[/]")
